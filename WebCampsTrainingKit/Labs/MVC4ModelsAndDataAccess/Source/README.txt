...
To run the end solutions of the following exercises:
  - Ex1-AddingADatabaseDBFirst
  - Ex3-QueryingTheDatabaseWithParametersDBFirst
First, include the MvcMusicStore.mdf file located in the Assets folder inside the MvcMusicStore\App_Data folder of the solution.